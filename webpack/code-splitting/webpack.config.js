...
const config = {
    ...
    module: {
        ...
        rules: [
            ...
            NOTE: presets needed are defined inside .babelrc file within the root directory
            -------------------*/
            {   
    ...
    -------------------*/
    plugins: [
        new ExtractTextPlugin('style.css') // Extracts styles to a separate file name for the styles
    ]
};
